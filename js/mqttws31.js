...
//    	    	break;
   ...
   ClientImpl.prototype.getTraceLog = function () {
    ...
    var Client = function (host, port, clientId) {
        ...
        if (typeof clientId !== "string" || clientIdLength < 1 | clientIdLength > 34)
     ...
     * @property {Boolean} retained If true, the message is to be retained by the server and delivered 
   	 ...
   	 * <p>
     * @property {Boolean} duplicate <i>read only</i> If true, this message might be aduplicate of one which has already been received. 
